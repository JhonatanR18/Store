...
const prod1 = new Product( // Primer elemento del array
    ...
    400,
    3,
    ['./assets/products/tablet.png','../assets/products/tablet.png', '../assets/products/tablet2.png', '../assets/products/tablet3.png'],
    ['Black', 'White', 'Gray'],
    '-12%',
    'Space Gray',
...
const prod2 = new Product( // segundo elemento del array
    ...
    1200,
    5,
    ['./assets/products/iphone.png','../assets/products/iphone.png', '../assets/products/iphone2.png', '../assets/products/iphone3.png'],
    ['Black', 'Blue'],
    '-20%',
    'Natural Titanium',
    "Experience the power of creativity with the MacBook Pro 13'4. Featuring 8GB of RAM and 512GB of storage, this laptop provides the performance and storage capacity needed for demanding tasks. The sleek design in silver and space gray adds a touch of sophistication. The high-resolution Retina display brings your visuals to life, whether you're editing photos, creating videos, or simply browsing the web. With the latest technology and a lightweight build, the MacBook Pro 13'4 is the perfect companion for professionals and creative individuals alike.",
...
const prod3 = new Product( // tercer elemento del array
    ...
    5637,
    2,
    ["./assets/products/MacbookPro.png" ,"../assets/products/MacbookPro.png", "../assets/products/MacbookPro2.png", "../assets/products/MacbookPro3.png"],
    ['Silver', 'Black'],
    '-12%',
    'Space Gray',
    "Experience the power of creativity with the MacBook Pro 13'4. Featuring 8GB of RAM and 512GB of storage, this laptop provides the performance and storage capacity needed for demanding tasks. The sleek design in silver and space gray adds a touch of sophistication. The high-resolution Retina display brings your visuals to life, whether you're editing photos, creating videos, or simply browsing the web. With the latest technology and a lightweight build, the MacBook Pro 13'4 is the perfect companion for professionals and creative individuals alike.",
...
const prod4 = new Product( // cuarto elemento del array
    ...
    400,
    8,
    ['./assets/products/monitor.png' ,'../assets/products/monitor.png', '../assets/products/monitor2.png', '../assets/products/monitor3.png'],
    ['Black'],
    '-10%',
...
const prod5 = new Product( // quinto elemento del array
    ...
    100,
    12,
    ['./assets/products/impresora.png', '../assets/products/impresora.png', '../assets/products/impresora2.png', '../assets/products/impresora3.png'],
    ['White'],
    '-25%',
    'Inyección de Tinta',
    "Experience the power of creativity with the MacBook Pro 13'4. Featuring 8GB of RAM and 512GB of storage, this laptop provides the performance and storage capacity needed for demanding tasks. The sleek design in silver and space gray adds a touch of sophistication. The high-resolution Retina display brings your visuals to life, whether you're editing photos, creating videos, or simply browsing the web. With the latest technology and a lightweight build, the MacBook Pro 13'4 is the perfect companion for professionals and creative individuals alike.",
...
const prod6 = new Product( // sexto elemento del array
    ...
    220,
    50,
    ['../assets/products/mouse.png', '../assets/products/mouse.png', '../assets/products/mouse3.png', '../assets/products/mouse5.png'],
    ['Black', 'Red'],
    '-12%',
    'Mouse inalámbrico',
    "Experience the power of creativity with the MacBook Pro 13'4. Featuring 8GB of RAM and 512GB of storage, this laptop provides the performance and storage capacity needed for demanding tasks. The sleek design in silver and space gray adds a touch of sophistication. The high-resolution Retina display brings your visuals to life, whether you're editing photos, creating videos, or simply browsing the web. With the latest technology and a lightweight build, the MacBook Pro 13'4 is the perfect companion for professionals and creative individuals alike.",
